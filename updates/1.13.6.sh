...
EOF
  ...
  isAppActive nc-autoupdate-ncp && runApp nc-autoupdate-ncp
  isAppActive nc-notify-updates && runApp nc-notify-updates
  isAppActive nc-previews-auto && runApp nc-previews-auto
  isAppActive nc-update-nc-apps-auto && runApp nc-update-nc-apps-auto
