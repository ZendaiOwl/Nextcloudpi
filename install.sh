...
runApp_unsafe bin/ncp/CONFIG/nc-nextcloud.sh
...
installApp    ncp.sh
runApp_unsafe bin/ncp/CONFIG/nc-init.sh
...
DISABLE_FS_CHECK=1 NCPCFG="/usr/local/etc/ncp.cfg" runApp_unsafe bin/ncp/CONFIG/nc-datadir.sh
